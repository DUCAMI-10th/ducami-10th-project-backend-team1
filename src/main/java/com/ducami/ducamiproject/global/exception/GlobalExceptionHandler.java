package com.ducami.ducamiproject.global.exception;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiResponse<Void>> handleMethodNotAllowedException(HttpClientErrorException.MethodNotAllowed ex) {
    ErrorResponse error = ErrorResponse.of(
  ...
  public ResponseEntity<ApiResponse<Void>> handleException(Exception ex) {
    log.error("요청 처리 중 에러 발생: {}", ex.toString());
    ErrorResponse error = ErrorResponse.of(
